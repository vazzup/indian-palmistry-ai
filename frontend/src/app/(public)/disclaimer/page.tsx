...
const disclaimerContent = `# Disclaimer - Indian Palmistry AI

**⚠️ IMPORTANT: READ BEFORE USING THIS SERVICE ⚠️**

## Entertainment Purpose Only

**Indian Palmistry AI is designed for entertainment and educational purposes only.** This service provides palm reading interpretations based on traditional Indian palmistry (Hast Rekha Shastra) combined with artificial intelligence analysis. 
